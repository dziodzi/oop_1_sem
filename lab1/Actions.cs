...
public class Actions
{
    ...
    public static RaceType InputRaceTypeAction()
    {
        {
            while (true)
            {
    ...
    public static WeatherType InputRaceWeatherAction()
    {
        while (true)
        {
            ...
            return weatherInput switch
            {
                ...
                2 => WeatherType.Rainy,
                3 => WeatherType.Windy,
                4 => WeatherType.Cloudy,
                5 => WeatherType.Stormy,
                6 => WeatherType.Snowy,
    ...
    public static List<Vehicle> SelectParticipantsAction(RaceType raceType)
    {
        ...
        while (true)
        {
            int input = GetPositiveIntInput("Enter transport number (or 0 to start the race):", 0,
                vehicles.Count);
